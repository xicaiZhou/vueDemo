  ...
  <div class="mContainer">
    <div class="mtools">
      <el-form label-width="90px" size="small" :inline="true">
        <!-- <el-form-item label-width="180px" label="提醒天数设置 代理合同">
          <el-input class="minput"  v-model="searchParams.w1" placeholder="请设置代理合同到期天数"></el-input> 天
        </el-form-item> -->
        ...
        <el-form-item label="代理合同">
          <el-input class="minput" v-model="searchParams.agencyDay" placeholder="请输入代理合同"></el-input> 天内
        </el-form-item>
        <el-form-item>
